...
const configs:Record<string,RoleConfig>={
 ...
 manager:{name:"Manager",title:"Monitoring & overview",initials:"MG",home:"/manager",nav:[{href:"/manager",label:"Overview",icon:"home"},{href:"/manager/supervisors",label:"Supervisors",icon:"users"},{href:"/manager/rsos",label:"RSOs",icon:"chart"},{href:"/manager/bp-activations",label:"BP Activations",icon:"sim"}],bottom:[]},
 supervisor:{name:"Supervisor",title:"Team management",initials:"SP",home:"/supervisor",nav:[{href:"/supervisor",label:"Overview",icon:"home"},{href:"/supervisor/rsos",label:"My RSOs",icon:"users"},{href:"/supervisor/retailers",label:"Retailers",icon:"shop"},{href:"/supervisor/bp-activations",label:"BP Activations",icon:"sim"}],bottom:[]},
 ...
 rso:{name:"RSO",title:"Field sales",initials:"RS",home:"/rso",nav:[{href:"/rso",label:"Home",icon:"home"},{href:"/rso/retailers",label:"Retailers",icon:"shop"},{href:"/rso/bp",label:"My BP",icon:"users"},{href:"/rso/bp/activations",label:"BP Activations",icon:"sim"}],bottom:[]},
