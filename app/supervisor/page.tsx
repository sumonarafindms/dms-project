...
export default async function Supervisor(){
 ...
 return <main className="page">
  ...
  <section className="section"><div className="quick-grid role-actions"><QuickAction href="/supervisor/attention" label="Attention" icon="target"/><QuickAction href="/supervisor/rsos" label="My RSOs" icon="users"/><QuickAction href="/supervisor/retailers" label="Retailers" icon="shop"/><QuickAction href="/supervisor/bp-activations" label="BP Activations" icon="sim"/></div></section>
 </main>
}
