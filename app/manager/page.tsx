...
export default async function Manager(){
 ...
 return <main className="page">
  ...
  <section className="section"><div className="quick-grid role-actions"><QuickAction href="/manager/attention" label="Attention" icon="target" module="attention"/><QuickAction href="/manager/supervisors" label="Supervisors" icon="users" module="employees"/><QuickAction href="/manager/rsos" label="RSO Performance" icon="chart" module="performance"/><QuickAction href="/manager/bp-activations" label="BP Activations" icon="sim" module="bp"/></div></section>
 </main>
}
