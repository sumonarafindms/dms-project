...
export default async function RSO(){
 ...
 return <main className="page field-page">
  ...
  <section className="section"><div className="quick-grid field-actions"><QuickAction href="/rso/attention" label="Attention" icon="target"/><QuickAction href="/rso/retailers" label="My Retailers" icon="shop"/><QuickAction href="/rso/bp" label="My BP" icon="users"/></div></section>
