...
export default async function Page(){
 ...
 return <main className="page admin-permissions premium-permissions"><div className="admin-kicker">ACCESS CONTROL</div><h1>Permissions</h1><p className="permissions-sub">Control individual access, apply role presets, or copy an existing permission setup.</p>
