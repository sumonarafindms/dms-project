...
export default function Page(){
 ...
 <section className="card admin-upload-box"><div className="upload-box-title"><div><strong>Upload Retailer List</strong><span>.xlsx, .xls or .xlsm</span></div><a href="/api/samples/retailers" className="btn upload-sample-btn">Download Sample File</a></div>
