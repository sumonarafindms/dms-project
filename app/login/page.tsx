...
export default function Login() {
  ...
  async function submit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        return setError(d.error || "Sign in failed");
      }
    ...
    <main className="auth-v54">
      <section className="auth-v54-brand">
        ...
        <div className="auth-v54-copy">
          <span className="auth-v54-kicker">
            FIELD SALES · DISTRIBUTION · EXECUTION
          </span>

          <h1>One workspace for your entire distribution team.</h1>

          <p>
            Monitor performance, manage retailers, maintain operational
            data and keep field execution connected across every role.
          </p>
      ...
      <section className="auth-v54-panel">
        <form className="auth-v54-card" onSubmit={submit}>
          ...
          <div className="auth-v58-team-badge">
            TEAM LOGIN
          </div>

          <div className="auth-v54-overline">
          ...
          <p className="auth-v54-intro">
            Use your authorized mobile number and PIN to continue.
          </p>
          ...
          {error && (
            <div className="auth-v54-error">
              {error}
            </div>
          )}

          <button
            className="auth-v54-submit"
            disabled={busy}
          >
          ...
          <div className="auth-v54-help">
            ...
            <span>
              Contact your administrator if your account or role
