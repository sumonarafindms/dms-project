...
export default function ObPage(){
  ...
  return <main style={{padding:28,maxWidth:1450,margin:"0 auto"}}><a href="/admin/upload" style={{color:"#475467"}}>← Upload Center</a><h1 style={{marginBottom:4}}>Opening Balance</h1><p style={{marginTop:0,color:"#667085"}}>Latest snapshot only. Every new OB upload fully replaces the previous retailer balances, so no daily OB history accumulates.</p>
