...
const definitions:Record<string,{name:string;sheet:string;rows:Record<string,unknown>[]}>={
  ga:{
    ...
    rows:[
      {RETAILER_CODE:"R000001",SIM_NO:"899110000000000001",PRODUCT_CODE:"MMSTC",SELLING_PRICE:170,ACTIVATION_DATE:"25-Aug-2026",ACTIVATION_TIME:"10:15:00 AM"},
      {RETAILER_CODE:"R000001",SIM_NO:"899110000000000002",PRODUCT_CODE:"MMST",SELLING_PRICE:300,ACTIVATION_DATE:"25-Aug-2026",ACTIVATION_TIME:"11:20:00 AM"},
      {RETAILER_CODE:"R000001",SIM_NO:"899110000000000003",PRODUCT_CODE:"SIMWAP",SELLING_PRICE:350,ACTIVATION_DATE:"25-Aug-2026",ACTIVATION_TIME:"12:10:00 PM"},
      {RETAILER_CODE:"R000002",SIM_NO:"899110000000000004",PRODUCT_CODE:"EV-SWAP",SELLING_PRICE:350,ACTIVATION_DATE:"25-Aug-2026",ACTIVATION_TIME:"01:20:00 PM"},
    ]
  },
  c2c:{
    name:"C2C_Sample.xlsx",sheet:"C2C Sample",
    rows:[
      {RETAILER_CODE:"R000001",RETAILER_ITOPUP_NO:"01700000001",TRANSACTION_COUNT:4,TOTAL_AMOUNT:700,SRNUMBER:"01900000001","01-Aug-2026":300,"02-Aug-2026":400},
  ...
  c2s:{
    ...
    rows:[
      {RETAILER_CODE:"R000001",RETAILER_ITOPUP_NO:"01700000001",TRANSACTION_COUNT:7,TOTAL_AMOUNT:650,SRNUMBER:"01900000001","01-Aug-2026":300,"02-Aug-2026":350},
